...
Commit-plan product wiring, progress projection, and advisor/review remain
later children of [#122](https://github.com/tyldra-org/falryn/issues/122).
...
- MCP, skills, plugin and other hook families, marketplace, agents, jobs, or
  ...
  task graph exists for #124, and focused validation advice exists for #125;
  they are not a command, model route, or orchestration graph); or
...
- **Open task intelligence parent:** [#122 Implement task intelligence and commit planning](https://github.com/tyldra-org/falryn/issues/122) is In Progress. Child [#123 Decompose user outcomes into bounded tasks without hidden scope growth](https://github.com/tyldra-org/falryn/issues/123) closed and Done via [PR #660](https://github.com/tyldra-org/falryn/pull/660) (`306d4a6`); companion docs [falryn-docs#213](https://github.com/tyldra-org/falryn-docs/pull/213) (`ac45108`). Child [#124 Represent dependencies, blockers, joins, and completion criteria](https://github.com/tyldra-org/falryn/issues/124) closed and Done via [PR #661](https://github.com/tyldra-org/falryn/pull/661) (`480e7eb`); companion docs [falryn-docs#214](https://github.com/tyldra-org/falryn-docs/pull/214) (`94745ca`). Child [#125 Recommend focused validation and negative controls](https://github.com/tyldra-org/falryn/issues/125) is the current required child.
- **Next planning action:** continue via [#126 Generate reviewable commit plans from actual changes](https://github.com/tyldra-org/falryn/issues/126) after #125 lands. Remaining children are [#127](https://github.com/tyldra-org/falryn/issues/127) and [#285](https://github.com/tyldra-org/falryn/issues/285). GitHub remains authoritative for ordering.