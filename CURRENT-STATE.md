...
- **Next planning action:** continue via [#99 Implement termination, disconnect, cancellation, and process cleanup](https://github.com/tyldra-org/falryn/issues/99). GitHub remains authoritative for ordering.
