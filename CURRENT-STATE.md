...
Advisor/review remain a later child of
[#122](https://github.com/tyldra-org/falryn/issues/122).
...
- MCP, skills, plugin and other hook families, marketplace, agents, jobs, or
  ...
  commit-plan product wiring exists for #126, and progress projection exists
  for #127; they are not a command, model route, or orchestration graph); or
