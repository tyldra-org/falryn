...
- `src/application/debug-adapter.ts` — `terminate`, `cancel`, idempotent
  ...
  `detach-uncertain` on unacknowledged detach. Artifact capture remains #100.
