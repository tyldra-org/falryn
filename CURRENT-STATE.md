...
- **Next planning action:** continue via [#249 Deliver the daily coding TUI experience](https://github.com/tyldra-org/falryn/issues/249) first remaining child [#252 Implement streaming coalescing with input-priority rendering](https://github.com/tyldra-org/falryn/issues/252). GitHub remains authoritative for ordering.
