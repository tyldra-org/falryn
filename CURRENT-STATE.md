...
- **Next planning action:** continue via [#115 Complete artifacts, export, replay, and recovery](https://github.com/tyldra-org/falryn/issues/115). GitHub remains authoritative for ordering.