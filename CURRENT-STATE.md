...
- **Next planning action:** continue v0.2 via [#47 Build the unified tool registry and execution pipeline](https://github.com/tyldra-org/falryn/issues/47). GitHub remains authoritative for ordering.
