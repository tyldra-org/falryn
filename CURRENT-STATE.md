...
`bun run check`. Composer slash aliases and LSP folder sync remain later #603
children.
...
- **Next planning action:** continue via [#603 Deliver multi-root workspaces and named layouts](https://github.com/tyldra-org/falryn/issues/603) (next child [#608](https://github.com/tyldra-org/falryn/issues/608) after #607). GitHub Project and Roadmap remain authoritative.