...
- **In-progress memory parent:** [#108 Implement durable memory and operational learning](https://github.com/tyldra-org/falryn/issues/108) is In Progress. Child [#109 Define attributed, correctable, versioned memory records](https://github.com/tyldra-org/falryn/issues/109) closed and Done via [PR #645](https://github.com/tyldra-org/falryn/pull/645) (`f5fd6d2`); companion docs [falryn-docs#201](https://github.com/tyldra-org/falryn-docs/pull/201) (`29cf0bd`). Child [#110 Implement context-governed memory admission and sensitivity rules](https://github.com/tyldra-org/falryn/issues/110) closed and Done via [PR #646](https://github.com/tyldra-org/falryn/pull/646) (`9656324`); companion docs [falryn-docs#202](https://github.com/tyldra-org/falryn-docs/pull/202) (`1b34a90`).
- **Next planning action:** continue via [#108 Implement durable memory and operational learning](https://github.com/tyldra-org/falryn/issues/108), next child [#112 Implement correction, supersession, deletion, and retention](https://github.com/tyldra-org/falryn/issues/112). GitHub remains authoritative for ordering.