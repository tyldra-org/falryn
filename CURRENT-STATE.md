...
command, OpenTUI overlay, fork, or rewind. Replay controls remain #261.
...
- a projection registry. One projection is maintained and its name is a closed
  ...
  command. User-facing rewind and reachability garbage collection remain
