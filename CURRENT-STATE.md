...
Last reconciled: **2026-08-20** (#699 live coding agent parent Done on `61aabf9`)
...
- **Active v0.35 frontier:** next parent [#700 Register built-in workspace and coding tools](https://github.com/tyldra-org/falryn/issues/700) (Todo). Remaining same-milestone parents: [#701](https://github.com/tyldra-org/falryn/issues/701)–[#704](https://github.com/tyldra-org/falryn/issues/704); optimize track [#736](https://github.com/tyldra-org/falryn/issues/736).
...
- **Next planning action:** start v0.35 parent [#700](https://github.com/tyldra-org/falryn/issues/700). GitHub Project and Roadmap remain authoritative.