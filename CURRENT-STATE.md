...
- **Next planning action:** continue via [#305 Attribute a late effect whose scope was already evicted](https://github.com/tyldra-org/falryn/issues/305). GitHub remains authoritative for ordering.
