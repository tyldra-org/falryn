...
- **Active search, indexing, and patches parent:** [#61 Deliver search, indexing foundations, and patches](https://github.com/tyldra-org/falryn/issues/61) is open. Child [#62 Implement bounded path and glob discovery](https://github.com/tyldra-org/falryn/issues/62) closed and Done via [PR #511](https://github.com/tyldra-org/falryn/pull/511) (`5fe59dd`); docs companion [falryn-docs#124](https://github.com/tyldra-org/falryn-docs/pull/124) (`36e5184`). Child [#63 Implement ripgrep-backed text search with a deterministic fallback](https://github.com/tyldra-org/falryn/issues/63) closed and Done via [PR #513](https://github.com/tyldra-org/falryn/pull/513) (`3063c46`); docs companion [falryn-docs#125](https://github.com/tyldra-org/falryn-docs/pull/125) (`557e010`). First remaining child is [#64 Implement structural and derived-index query foundations](https://github.com/tyldra-org/falryn/issues/64).
- **Open falryn v0.1 Foundation product issues:** none remaining.
- **Next planning action:** continue #61 via [#64 Implement structural and derived-index query foundations](https://github.com/tyldra-org/falryn/issues/64). GitHub remains authoritative for ordering.
