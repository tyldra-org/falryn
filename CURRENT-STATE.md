...
`src/cli/artifact-commands.test.ts`, and `bun run check`. Over-bound machine
refusal handles remain #341.
...
- **Next planning action:** continue via [#341 Carry an artifact handle on an over-bound machine refusal record](https://github.com/tyldra-org/falryn/issues/341). GitHub Project and Roadmap remain authoritative.