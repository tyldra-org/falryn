...
Last reconciled: **2026-08-20** (#715 context planner on the v0.35 frontier)
...
- **Active context/compression parent:** [#701 Wire context, Brief, Hush, Loom, and memory into live turns](https://github.com/tyldra-org/falryn/issues/701) is In Progress. Child [#715](https://github.com/tyldra-org/falryn/issues/715) lands `createContextPlanner` on live `falryn run` and TUI submission. Remaining: [#716](https://github.com/tyldra-org/falryn/issues/716)–[#720](https://github.com/tyldra-org/falryn/issues/720).
...
- **Next planning action:** continue parent [#701](https://github.com/tyldra-org/falryn/issues/701) at [#716](https://github.com/tyldra-org/falryn/issues/716) after #715 lands. GitHub Project and Roadmap remain authoritative.