...
- **In-progress memory parent:** [#108 Implement durable memory and operational learning](https://github.com/tyldra-org/falryn/issues/108) is In Progress. Child [#109 Define attributed, correctable, versioned memory records](https://github.com/tyldra-org/falryn/issues/109) closed and Done via [PR #645](https://github.com/tyldra-org/falryn/pull/645) (`f5fd6d2`); companion docs [falryn-docs#201](https://github.com/tyldra-org/falryn-docs/pull/201) (`29cf0bd`).
- **Next planning action:** continue via [#108 Implement durable memory and operational learning](https://github.com/tyldra-org/falryn/issues/108), next child [#111 Implement recall, ranking, freshness, and contradiction handling](https://github.com/tyldra-org/falryn/issues/111). GitHub remains authoritative for ordering.