...
- **Active shell, PTY, process, and Hush parent:** [#68 Deliver shell, PTY, process, and Hush foundations](https://github.com/tyldra-org/falryn/issues/68) is open and In Progress. Child [#69 Implement supervised direct-argv and Bash command execution](https://github.com/tyldra-org/falryn/issues/69) is closed and Done via [PR #527](https://github.com/tyldra-org/falryn/pull/527) (`943fbbaf`); companion docs [falryn-docs#132](https://github.com/tyldra-org/falryn-docs/pull/132) (`8df4510`). First remaining child is [#70 Implement PTY sessions and long-lived managed process services](https://github.com/tyldra-org/falryn/issues/70).
- **Open falryn v0.1 Foundation product issues:** none remaining.
- **Next planning action:** continue #68 via [#70 Implement PTY sessions and long-lived managed process services](https://github.com/tyldra-org/falryn/issues/70). GitHub remains authoritative for ordering.
