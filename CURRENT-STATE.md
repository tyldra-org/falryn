...
Last reconciled: **2026-08-20** (#752 default TUI product submission wiring on the v0.35 frontier)
...
- **Active live coding agent parent:** [#699 Deliver the live coding agent end-to-end](https://github.com/tyldra-org/falryn/issues/699) is In Progress. Children [#705](https://github.com/tyldra-org/falryn/issues/705)–[#710](https://github.com/tyldra-org/falryn/issues/710) landed composition, producers, submission port, `falryn run`, live adapter, and credential bootstrap. Child [#752](https://github.com/tyldra-org/falryn/issues/752) wires `composeProductShellAttachments` into default `launchShell` so TUI submit uses the product port (parent integrated verification gap after #710).
...
- **Next planning action:** after [#752](https://github.com/tyldra-org/falryn/issues/752) lands, re-run parent integrated verification for [#699](https://github.com/tyldra-org/falryn/issues/699), then continue v0.35 at the next Ready parent. GitHub Project and Roadmap remain authoritative.