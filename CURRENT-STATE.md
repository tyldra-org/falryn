...
- **Open Git, worktree, and checkpoint parent:** [#75 Deliver Git, worktree, and checkpoint tools](https://github.com/tyldra-org/falryn/issues/75) remains open and In Progress. Child [#76 Implement Git status, diff, log, blame, and repository discovery](https://github.com/tyldra-org/falryn/issues/76) closed and Done via [PR #539](https://github.com/tyldra-org/falryn/pull/539) (`9c19c52a`); companion docs [falryn-docs#138](https://github.com/tyldra-org/falryn-docs/pull/138) (`403d7de0`).
- **Next planning action:** continue via [#75 Deliver Git, worktree, and checkpoint tools](https://github.com/tyldra-org/falryn/issues/75) first remaining child [#77 Integrate patches with dirty-tree and conflict awareness](https://github.com/tyldra-org/falryn/issues/77). GitHub remains authoritative for ordering.
