...
- **Next planning action:** continue via [#101 Implement Brief, Hush, Loom, and compression](https://github.com/tyldra-org/falryn/issues/101). GitHub remains authoritative for ordering.