...
- **Active shell, PTY, process, and Hush parent:** [#68 Deliver shell, PTY, process, and Hush foundations](https://github.com/tyldra-org/falryn/issues/68) is open. First remaining child is [#69 Implement supervised direct-argv and Bash command execution](https://github.com/tyldra-org/falryn/issues/69).
- **Open falryn v0.1 Foundation product issues:** none remaining.
- **Next planning action:** continue #68 via [#69 Implement supervised direct-argv and Bash command execution](https://github.com/tyldra-org/falryn/issues/69). GitHub remains authoritative for ordering.
