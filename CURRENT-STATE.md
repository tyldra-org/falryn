...
- **Next planning action:** continue via [#249 Deliver the daily coding TUI experience](https://github.com/tyldra-org/falryn/issues/249) first remaining child [#279 Implement editable prompt enhancement without implicit submission](https://github.com/tyldra-org/falryn/issues/279). GitHub remains authoritative for ordering.
