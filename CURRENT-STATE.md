...
`src/domain/session-isolation.test.ts` under `bun run check`. Named layouts,
CLI `--add-dir`, palette commands, and LSP folder sync remain later #603
children.
...
- **Next planning action:** continue via [#603 Deliver multi-root workspaces and named layouts](https://github.com/tyldra-org/falryn/issues/603) (next child [#605](https://github.com/tyldra-org/falryn/issues/605) after #604). GitHub Project and Roadmap remain authoritative.