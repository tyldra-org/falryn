...
- **Next planning action:** continue via [#249 Deliver the daily coding TUI experience](https://github.com/tyldra-org/falryn/issues/249) first remaining child [#253 Implement grapheme-aware multiline composer, paste, history, and drafts](https://github.com/tyldra-org/falryn/issues/253). GitHub remains authoritative for ordering.
