...
- **Active debugging parent:** [#95 Deliver debugging through DAP](https://github.com/tyldra-org/falryn/issues/95) is **In Progress**. Child [#96 Implement debug-adapter supervision and request-response transport](https://github.com/tyldra-org/falryn/issues/96) is verified in tree on this branch pending merge.
- **Next planning action:** after #96 lands, continue via [#97 Implement launch, attach, breakpoint, thread, and stack lifecycles](https://github.com/tyldra-org/falryn/issues/97). GitHub remains authoritative for ordering.
