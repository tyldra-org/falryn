...
- **Next planning action:** continue via [#90 Synchronize workspaces, documents, versions, and dynamic capabilities](https://github.com/tyldra-org/falryn/issues/90). GitHub remains authoritative for ordering.
