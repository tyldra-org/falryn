...
- **Open session navigation parent:** [#257 Deliver session navigation, resume, fork, and rewind](https://github.com/tyldra-org/falryn/issues/257) is In Progress. Child [#258 Implement session list, naming, pinning, filtering, and search](https://github.com/tyldra-org/falryn/issues/258) is closed and Done via [PR #668](https://github.com/tyldra-org/falryn/pull/668) (`e2787c8`); companion docs [falryn-docs#220](https://github.com/tyldra-org/falryn-docs/pull/220) (`4bad586`). Child [#259 Implement crash-safe resume from durable event cursors](https://github.com/tyldra-org/falryn/issues/259) is closed and Done via [PR #669](https://github.com/tyldra-org/falryn/pull/669) (`93f2a17`); companion docs [falryn-docs#221](https://github.com/tyldra-org/falryn-docs/pull/221) (`642db46`). Child [#260 Implement session fork and rewind-as-new-history semantics](https://github.com/tyldra-org/falryn/issues/260) is closed and Done via [PR #670](https://github.com/tyldra-org/falryn/pull/670) (`dd5c4ec`); companion docs [falryn-docs#222](https://github.com/tyldra-org/falryn-docs/pull/222) (`37403ea`). Child [#261 Implement transcript replay controls without repeating effects](https://github.com/tyldra-org/falryn/issues/261) is closed and Done via [PR #671](https://github.com/tyldra-org/falryn/pull/671) (`d04d0b7`); companion docs [falryn-docs#223](https://github.com/tyldra-org/falryn-docs/pull/223) (`300dd57`). Child [#262 Implement workspace and session isolation with stale-source warnings](https://github.com/tyldra-org/falryn/issues/262) is the current required child.
- **Next planning action:** after #262 lands, continue via [#263 Implement session export, import, and recovery interactions](https://github.com/tyldra-org/falryn/issues/263). GitHub remains authoritative for ordering.