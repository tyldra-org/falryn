...
- **Next planning action:** continue via [#249 Deliver the daily coding TUI experience](https://github.com/tyldra-org/falryn/issues/249) first remaining child [#251 Implement windowed transcript projection and stable scroll anchors](https://github.com/tyldra-org/falryn/issues/251). GitHub remains authoritative for ordering.
