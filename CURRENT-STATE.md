...
`src/application/workspace-layout.test.ts` under `bun run check`. CLI
`--add-dir` / `workspace` group, palette commands, and LSP folder sync remain
later #603 children.
...
- **Next planning action:** continue via [#603 Deliver multi-root workspaces and named layouts](https://github.com/tyldra-org/falryn/issues/603) (next child [#606](https://github.com/tyldra-org/falryn/issues/606) after #605). GitHub Project and Roadmap remain authoritative.