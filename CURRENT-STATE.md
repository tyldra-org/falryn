...
- **Next planning action:** continue via [#257 Deliver session navigation, resume, fork, and rewind](https://github.com/tyldra-org/falryn/issues/257). GitHub remains authoritative for ordering.