...
command or OpenTUI overlay. Durable retention-GC pins, resume, rewind, and
...
- **Open session navigation parent:** [#257 Deliver session navigation, resume, fork, and rewind](https://github.com/tyldra-org/falryn/issues/257) is In Progress. Child [#258 Implement session list, naming, pinning, filtering, and search](https://github.com/tyldra-org/falryn/issues/258) is the current required child.
- **Next planning action:** after #258 lands, continue via [#259 Implement crash-safe resume from durable event cursors](https://github.com/tyldra-org/falryn/issues/259). GitHub remains authoritative for ordering.