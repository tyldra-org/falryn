...
`bun run check`. Palette commands and LSP folder sync remain later #603
children.
...
- **Next planning action:** continue via [#603 Deliver multi-root workspaces and named layouts](https://github.com/tyldra-org/falryn/issues/603) (next child [#607](https://github.com/tyldra-org/falryn/issues/607) after #606). GitHub Project and Roadmap remain authoritative.