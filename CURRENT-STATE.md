...
- **Active search, indexing, and patches parent:** [#61 Deliver search, indexing foundations, and patches](https://github.com/tyldra-org/falryn/issues/61) is open. First required child is [#62 Implement bounded path and glob discovery](https://github.com/tyldra-org/falryn/issues/62).
- **Open falryn v0.1 Foundation product issues:** none remaining.
- **Next planning action:** continue #61 via [#62 Implement bounded path and glob discovery](https://github.com/tyldra-org/falryn/issues/62). GitHub remains authoritative for ordering.
