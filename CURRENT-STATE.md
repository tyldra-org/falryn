...
- `src/application/workspace-index-build.ts` — `createWorkspaceIndexBuilder`
  persists a rebuilt generation for the existing #64 query seam. Watchers,
  Tree-sitter, and embeddings remain #94 / later.
