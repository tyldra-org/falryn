...
`bun run check`. Composer slash aliases remain a later #603 child.
...
- **Next planning action:** continue via [#603 Deliver multi-root workspaces and named layouts](https://github.com/tyldra-org/falryn/issues/603) (next child [#609](https://github.com/tyldra-org/falryn/issues/609) after #608). GitHub Project and Roadmap remain authoritative.