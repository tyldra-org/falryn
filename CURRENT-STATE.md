...
Dependencies, joins, validation recommendations, commit-plan product wiring,
...
- MCP, skills, plugin and other hook families, marketplace, agents, jobs, or
  workflows (deterministic goal decomposition exists for #123 as advice only;
  it is not a command, model route, or orchestration graph); or
...
- **Open task intelligence parent:** [#122 Implement task intelligence and commit planning](https://github.com/tyldra-org/falryn/issues/122) is In Progress. Child [#123 Decompose user outcomes into bounded tasks without hidden scope growth](https://github.com/tyldra-org/falryn/issues/123) is the first required child of this parent.
- **Next planning action:** continue via [#124 Represent dependencies, blockers, joins, and completion criteria](https://github.com/tyldra-org/falryn/issues/124) after #123 lands. Remaining children are [#125](https://github.com/tyldra-org/falryn/issues/125), [#126](https://github.com/tyldra-org/falryn/issues/126), [#127](https://github.com/tyldra-org/falryn/issues/127), and [#285](https://github.com/tyldra-org/falryn/issues/285). GitHub remains authoritative for ordering.