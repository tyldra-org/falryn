...
- workspace shell, Git, LSP, DAP, browser, or computer-use capabilities (path
...
- **Active shell, PTY, process, and Hush parent:** [#68 Deliver shell, PTY, process, and Hush foundations](https://github.com/tyldra-org/falryn/issues/68) is open and In Progress. Child [#69 Implement supervised direct-argv and Bash command execution](https://github.com/tyldra-org/falryn/issues/69) is closed and Done via [PR #527](https://github.com/tyldra-org/falryn/pull/527) (`943fbbaf`); companion docs [falryn-docs#132](https://github.com/tyldra-org/falryn-docs/pull/132) (`8df4510`). Child [#70 Implement PTY sessions and long-lived managed process services](https://github.com/tyldra-org/falryn/issues/70) is closed and Done via [PR #529](https://github.com/tyldra-org/falryn/pull/529) (`afe53d2b`); companion docs [falryn-docs#133](https://github.com/tyldra-org/falryn-docs/pull/133) (`0b273fba`). Child [#71 Capture ordered output, exits, limits, and artifact spillover](https://github.com/tyldra-org/falryn/issues/71) is closed and Done via [PR #531](https://github.com/tyldra-org/falryn/pull/531) (`ac905090`); companion docs [falryn-docs#134](https://github.com/tyldra-org/falryn-docs/pull/134) (`7d7c0a0a`). Child [#72 Implement Hush command-output reducers over exact process facts](https://github.com/tyldra-org/falryn/issues/72) is closed and Done via [PR #533](https://github.com/tyldra-org/falryn/pull/533) (`7514dc7e`); companion docs [falryn-docs#135](https://github.com/tyldra-org/falryn-docs/pull/135) (`4a146f66`). Child [#73 Implement process-tree cancellation, deadlines, and cleanup](https://github.com/tyldra-org/falryn/issues/73) is closed and Done via [PR #535](https://github.com/tyldra-org/falryn/pull/535) (`b28f1ce8`); companion docs [falryn-docs#136](https://github.com/tyldra-org/falryn-docs/pull/136) (`1a98c9e4`). First remaining child is [#74 Add shell quoting, platform, truncation, and interruption fixtures](https://github.com/tyldra-org/falryn/issues/74).
- **Open falryn v0.1 Foundation product issues:** none remaining.
- **Next planning action:** continue #68 via [#74 Add shell quoting, platform, truncation, and interruption fixtures](https://github.com/tyldra-org/falryn/issues/74). GitHub remains authoritative for ordering.
