...
- **Next planning action:** continue via [#81 Implement the context engine and context packs](https://github.com/tyldra-org/falryn/issues/81) first remaining child [#82 Define evidence candidates, provenance, freshness, and exact-source handles](https://github.com/tyldra-org/falryn/issues/82). GitHub remains authoritative for ordering.
