...
- LSP feature requests, DAP, browser, or computer-use capabilities
  (language-server supervision, JSON-RPC framing, initialize/shutdown, and
  document/workspace/capability sync exist for #89–#90; path bind, list/stat/
