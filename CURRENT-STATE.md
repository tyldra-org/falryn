...
Last reconciled: **2026-08-20** (#708 headless `falryn run` on the v0.35 frontier)
...
- **Active live coding agent parent:** [#699 Deliver the live coding agent end-to-end](https://github.com/tyldra-org/falryn/issues/699) is In Progress. Child [#705](https://github.com/tyldra-org/falryn/issues/705) landed `composeProductAgentRuntime`. Child [#706](https://github.com/tyldra-org/falryn/issues/706) landed producers + transcriptFeed. Child [#707](https://github.com/tyldra-org/falryn/issues/707) landed `createProductSubmissionPort`. Child [#708](https://github.com/tyldra-org/falryn/issues/708) declares `falryn run` (`src/cli/coding-run.ts`) with the four output contracts; hosts a product session/turn and fails closed without a live provider (#709). Remaining children: [#709](https://github.com/tyldra-org/falryn/issues/709)–[#710](https://github.com/tyldra-org/falryn/issues/710).
...
- **Next planning action:** continue v0.35 parent [#699](https://github.com/tyldra-org/falryn/issues/699) at child [#709](https://github.com/tyldra-org/falryn/issues/709) after #708 lands. GitHub Project and Roadmap remain authoritative.