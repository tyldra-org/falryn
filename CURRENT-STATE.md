...
- **Next planning action:** continue via [#88 Deliver language intelligence and derived indexing](https://github.com/tyldra-org/falryn/issues/88). GitHub remains authoritative for ordering.
