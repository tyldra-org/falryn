...
- **Next planning action:** continue via [#95 Deliver debugging through DAP](https://github.com/tyldra-org/falryn/issues/95) / first child [#96 Implement debug-adapter supervision and request-response transport](https://github.com/tyldra-org/falryn/issues/96). GitHub remains authoritative for ordering.
