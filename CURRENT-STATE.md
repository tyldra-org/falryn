...
Progress projection and advisor/review remain later children of
...
- MCP, skills, plugin and other hook families, marketplace, agents, jobs, or
  ...
  commit-plan product wiring exists for #126; they are not a command, model
  route, or orchestration graph); or
