#!/usr/bin/env bun
import { composeProductCredentials } from "../../src/cli/runtime/product-credentials.ts";
...
import { resolveProviderApiKey } from "../../src/application/authentication/index.ts";
import {
...
} from "../../src/application/compression/index.ts";
import type { GlobalOptions } from "../../src/cli/options.ts";
import { createRecordingCliStreams } from "../../src/cli/output/streams.ts";
import { runCoding } from "../../src/cli/runtime/coding-run.ts";
import { createServiceProvider } from "../../src/cli/runtime/services.ts";
import {
  ...
  compareBriefPair,
} from "../../src/domain/compression/index.ts";
import type { PromptSectionInput } from "../../src/domain/context/index.ts";
import {
  createStaticEnvironment,
  createSystemClock,
  instant,
  ok,
} from "../../src/domain/foundation/index.ts";
import { localPath } from "../../src/domain/workspace/index.ts";
import {
