...
import { commandShape } from "../../src/domain/compression/hush/invocation/normalize.ts";
import {
  HUSH_COMMAND_RULES,
  HUSH_PROJECTION_KINDS,
  matchHushCommand,
} from "../../src/domain/compression/hush/routing/index.ts";
import { duration } from "../../src/domain/foundation/clock.ts";
import {
