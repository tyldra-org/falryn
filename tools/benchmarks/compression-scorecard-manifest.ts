...
export const COMPRESSION_PRODUCT_PATH_TESTS = [
  "src/application/runtime/product-attempt-runner.test.ts",
  "src/application/workspace/product-read.test.ts",
  "src/application/tools/product-tools-process.test.ts",
  "src/cli/runtime/coding-run.test.ts",
] as const;
