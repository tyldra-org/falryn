#!/usr/bin/env python3
"""Validate github-operations structure, routing, and local Markdown links."""
...
def main() -> int:
    ...
    if not skill_text.startswith("---\n"):
        ...
        if "name: github-operations" not in frontmatter:
            errors.append("SKILL.md name must be github-operations")
    ...
    print(
        "github-operations validation passed: "
