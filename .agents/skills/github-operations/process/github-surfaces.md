...
Adding or deleting account keys changes authentication/signing trust. Verify fingerprints locally, never upload private keys, and confirm removals. For signing policy and local Git configuration, also read [audit.md](../../git-operations/reference/audit.md).
