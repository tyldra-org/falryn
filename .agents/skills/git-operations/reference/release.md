...
Version policy, tags, and changelogs. Pushing a tag is outward-facing and effectively permanent, so confirm it. GitHub Releases are **github-operations** `process/release.md`.
...
- The commit being tagged is the one you intend to ship. If CI is the gate, confirm it on that commit via **github-operations** before tagging.
