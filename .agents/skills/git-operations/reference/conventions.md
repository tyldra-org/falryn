...
Message text and naming. Load before writing any commit subject, branch name, or tag. Pull-request titles live in **github-operations** `process/pr.md`.
...
message and metadata follow repository policy; **github-operations** `process/merge.md`.
