#!/usr/bin/env python3
"""Validate git-operations structure, routing, and Markdown links."""
...
def main() -> int:
    ...
    if not skill_text.startswith("---\n"):
        ...
        if "name: git-operations" not in frontmatter:
            errors.append("SKILL.md name must be git-operations")
    ...
    print(
        "git-operations validation passed: "
