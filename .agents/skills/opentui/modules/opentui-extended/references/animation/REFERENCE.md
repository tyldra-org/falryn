...
> Companion patterns for timelines and easing. Confirm APIs against the pinned installed OpenTUI version and matching vendored docs; consult upstream only to investigate a mismatch or planned upgrade.
