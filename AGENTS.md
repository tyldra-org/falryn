...
| Origin CLI syntax, mirror setup, light Origin rulesets, or `origin pr` / `origin repo` flags | `origin-cli` at `~/.agents/skills/origin-cli/` (install/login repair: Cursor built-in `origin` skill) |
