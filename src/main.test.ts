...
describe("application bootstrap", () => {
  ...
  test("opens the database in the state root and migrates it", async () => {
    ...
    // The production set is migrations 0001 through 0017, so a clean run ends
    // at the current schema with records, artifacts, runs, provenance, memory,
    // Loom manifests, model catalogs, scratch resources, and provider
    // continuation state, process tasks, trust decisions and package lifecycle in place.
