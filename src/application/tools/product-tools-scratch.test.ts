...
import { parseScratchName, scratchHandle, scratchRevision } from "../../domain/artifacts/index.ts";
import {
  capabilityId,
...
import type { ScratchMetadata, ScratchResourcePort } from "../artifacts/scratch-resources.ts";
