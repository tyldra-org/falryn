...
import type { CapabilityHealthEvidence } from "../../domain/capabilities/capability-health.ts";
import {
...
import type { DiagnosticsCollector } from "../diagnostics/diagnostics-collector.ts";
