...
} from "../../domain/compression/hush/invocation/github.ts";
import {
  gitlabCommand,
  gitlabCommandArguments,
  hasGitlabOutputOverride,
} from "../../domain/compression/hush/invocation/gitlab.ts";
import { commandShape } from "../../domain/compression/hush/invocation/normalize.ts";
import type { ProcessCaptureRequest } from "../../domain/process/index.ts";
