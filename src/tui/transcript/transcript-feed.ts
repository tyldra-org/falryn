...
import type { SessionTurnTranscriptProducer } from "../../application/sessions/session-turn-transcript-producer.ts";
...
import type { RenderKind } from "../runtime/render-schedule.ts";
import { IMMEDIATE_GATE, type RenderGate } from "../visual/render-gate.tsx";
