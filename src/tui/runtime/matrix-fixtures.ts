...
export const TUI_MATRIX: readonly MatrixRow[] = [
  {
    ...
    owner: {
      kind: "test",
      file: "src/tui/runtime/launch.test.ts",
  ...
  },
  {
    ...
    owner: {
      kind: "test",
      file: "src/tui/runtime/renderer-session.test.ts",
  ...
  },
  {
    ...
    owner: {
      kind: "test",
      file: "src/tui/runtime/shell.test.tsx",
      test: "gives the terminal back",
    },
  },
  {
    ...
    owner: {
      kind: "test",
      file: "src/tui/shell/frame.test.tsx",
  ...
  },
  {
    ...
    owner: {
      kind: "test",
      file: "src/tui/overlays/interaction.test.tsx",
  ...
  },
  {
    ...
    owner: {
      kind: "test",
      file: "src/domain/terminal/text-display.test.ts",
  ...
  },
  {
    ...
    owner: {
      kind: "test",
      file: "src/tui/runtime/shell.compiled.test.ts",
      test: "opens help, scrolls",
    },
  },
  {
    ...
    owner: {
      kind: "test",
      file: "src/tui/runtime/harness.test.tsx",
  ...
  },
  {
    ...
    owner: { kind: "test", file: "src/tui/shell/frame.test.tsx", test: "survives a storm" },
  },
  {
