...
import { createStaticEnvironment, type EnvironmentPort } from "../../domain/foundation/index.ts";
import { type ObservedHandles, terminalCapabilities } from "../../domain/terminal/index.ts";
import { type ShellCapabilities, shellCapabilities } from "../runtime/capabilities.ts";
