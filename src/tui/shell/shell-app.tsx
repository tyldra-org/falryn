...
import { searchCommands } from "../commands/commands.ts";
import {
  activeCommandIds,
  commandRows,
  describeRefusal,
  type KeymapPlan,
  planKeymap,
} from "../commands/keymap.ts";
import type { ComposerModel } from "../composer/composer-model.ts";
...
import type { TranscriptModel } from "../transcript/transcript-model.ts";
import { KeymapBridge } from "../visual/keymap-bridge.tsx";
import {
