...
export const OPERATION_COMMANDS = [
  {
    ...
    examples: ["docker ps", "docker images", "docker compose ps", "skopeo inspect image"],
  ...
  },
  {
    ...
    examples: ["docker logs app", "docker compose logs"],
  ...
  },
  {
    ...
    executables: ["docker", "podman", "skopeo"],
    examples: ["docker run image", "docker exec app command", "skopeo copy source target"],
  },
  {
