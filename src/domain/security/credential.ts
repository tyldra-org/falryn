...
import type { CredentialReference, CredentialStoreKind } from "../configuration/configuration.ts";
import type { DurationMs, Instant } from "../foundation/clock.ts";
import type { LocalDataPlatform } from "../storage/local-data.ts";
