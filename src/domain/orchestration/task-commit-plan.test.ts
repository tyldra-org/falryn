...
import { instant } from "../foundation/clock.ts";
import { outcomeId, taskId } from "../foundation/identity.ts";
import { planGitCommits } from "../git/commit-plan.ts";
import type { GitIdentity, GitStatusEntry } from "../git/git.ts";
import { localPath } from "../workspace/filesystem.ts";
import {
  planTaskCommits,
