...
import type { ArtifactId } from "../../artifacts/artifact.ts";
import type { DurationMs } from "../../foundation/clock.ts";
import type { ProcessCaptureId } from "../../foundation/identity.ts";
import type { Result } from "../../foundation/result.ts";
import type { CommandMode, CommandRequest } from "../../process/process.ts";
import type {
