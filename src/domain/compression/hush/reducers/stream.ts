/** Byte bounds and stream composition shared by Hush reducers. */

import type { ProcessStreamCapture, ProcessStreamName } from "../../../process/process-capture.ts";
import type { HushOmission, HushStreamProjection } from "../contracts.ts";
import { compactDuplicateRuns } from "./shared/text.ts";
