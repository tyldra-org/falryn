...
import { duration, instant, processCaptureId } from "../../../../foundation/index.ts";
import type { ProcessCaptureReport } from "../../../../process/index.ts";
import { packageProjection } from "./reduce.ts";

describe("Hush package reducer", () => {
