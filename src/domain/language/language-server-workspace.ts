...
import type { ConfigurationGeneration, WorkspaceRootId } from "../foundation/identity.ts";
import { err, ok, type Result } from "../foundation/result.ts";
import { type LocalPath, parseLocalPath } from "../workspace/filesystem.ts";
import type { WorkspaceRootEntry, WorkspaceSet } from "../workspace/workspace-set.ts";
import type {
