...
import type { ManagedServiceId, PtySessionId, ServiceGeneration } from "../foundation/identity.ts";
import { err, ok, type Result } from "../foundation/result.ts";
import { MAX_TERMINAL_COLUMNS, MIN_TERMINAL_COLUMNS } from "../terminal/terminal.ts";
import {
