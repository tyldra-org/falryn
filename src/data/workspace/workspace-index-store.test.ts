...
import { createWorkspaceIndexQuery } from "../../application/workspace/workspace-index.ts";
import { createWorkspaceIndexBuilder } from "../../application/workspace/workspace-index-build.ts";
...
describe("workspace index sqlite store", () => {
  ...
  test("rebuilds a generation and serves query hits", async () => {
    ...
    const { createInMemoryFileSystem } = await import("../../domain/workspace/index.ts");
