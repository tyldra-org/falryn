...
describe("the production set", () => {
  test("is migrations 0001 through 0004, and validates", () => {
    ...
    // order, and closes at version 4.
    expect(PRODUCTION_MIGRATIONS.map((migration) => migration.version)).toEqual([1, 2, 3, 4]);
